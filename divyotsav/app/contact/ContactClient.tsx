...
export default function ContactClient({ siteSettings }: ContactClientProps) {
  ...
  const contactCards = [
    { 
      title: "Phone", 
      value: siteSettings?.phone || "+91 98765 43210", 
      link: siteSettings?.phone ? `tel:${siteSettings.phone.replace(/\s+/g, "")}` : "tel:+919876543210" 
    },
    { 
      title: "Email", 
      value: siteSettings?.email || "hello@divyotsav.com", 
      link: siteSettings?.email ? `mailto:${siteSettings.email}` : "mailto:hello@divyotsav.com" 
    },
    { 
      title: "Instagram", 
      value: siteSettings?.instagramHandle || "@divyotsav", 
      link: siteSettings?.instagramHandle ? `https://instagram.com/${siteSettings.instagramHandle.replace(/^@/, "")}` : "https://instagram.com/divyotsav" 
    },
    { 
      title: "Consultation Hours", 
      value: siteSettings?.consultationHours || "Mon–Sat · 10:00 AM – 7:00 PM IST", 
      link: null 
    },
  ];

  const mapSource = siteSettings?.googleMapsUrl || "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3774.22564251786!2d72.8228514757342!3d18.909249782522775!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7d1e8c0e2a39f%3A0xe54cfeb9efcb006c!2sColaba%2C%20Mumbai%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1718440000000!5m2!1sen!2sin";
        ...
        >
          ...
          >
            ...
            <p className="text-base text-obsidian leading-relaxed">
              {siteSettings?.address || "108, Sanskriti Heights, Luxury Avenue, Colaba, Mumbai – 400005, Maharashtra, India"}
            </p>
          </div>
        </motion.div>
