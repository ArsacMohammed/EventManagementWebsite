      ...
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 mb-16">
        ...
        <div className="flex flex-col space-y-6">
          ...
          <p className="text-warm-gray text-sm font-light tracking-wide max-w-[280px] leading-relaxed">
            {siteSettings?.tagline || "Divyotsav is born of a sacred vision where ancient geometry and timeless cultural rituals meet modern design excellence. We craft celebrations that live forever."}
          </p>
        </div>
        ...
        <div className="flex flex-col space-y-6">
          ...
          <div className="flex flex-col space-y-4 text-sm font-light tracking-wider text-warm-gray">
            ...
            {siteSettings?.phone && (
              <p>
                Phone:{" "}
                <a href={`tel:${siteSettings.phone.replace(/\s+/g, "")}`} className="text-cream hover:text-gold transition-colors">
                  {siteSettings.phone}
                </a>
              </p>
            )}
            {siteSettings?.email && (
              <p>
                Email:{" "}
                <a href={`mailto:${siteSettings.email}`} className="text-cream hover:text-gold transition-colors">
                  {siteSettings.email}
                </a>
              </p>
            )}
            ...
            <div className="flex items-center space-x-4 pt-2">
              ...
              {siteSettings?.whatsappNumber && (
                <a
                  href={`https://wa.me/${siteSettings.whatsappNumber.replace(/\+/g, "").replace(/\s+/g, "")}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-cream hover:text-gold transition-colors duration-300"
                  aria-label="WhatsApp"
